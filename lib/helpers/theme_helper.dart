...
class ThemeHelper {
  InputDecoration textInputDecoration([String lableText = "", String hintText = ""]) {
    return InputDecoration(
      ...
      focusedBorder:
          OutlineInputBorder(borderRadius: BorderRadius.circular(100.0), borderSide: BorderSide(color: Colors.grey)),
  ...
  ButtonStyle buttonStyle() {
    return ButtonStyle(
      ...
      backgroundColor: MaterialStateProperty.all(GlobalVariables.backgroundColor),
